...
This week, we learned about Express middleware and routing, which are two of the main features or advantages of using Express.

- [ ] Describe Middleware?

Middleware is a name used to describe the set of functions that receive the request and response objects, operate on them, and (when specified) trigger an action.

- [ ] Describe a Resource?

The term Resource is used to described data that is stored on a server and might be called by upon by a client.

- [ ] What can the API return to help clients know if a request was successful?

The API returns a response object, which has several properties that one can use to communicate with the client, such as the status, error, and message props.

- [ ] How can we partition our application into sub-applications?

Routing and imports/required modules.
